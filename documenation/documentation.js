...
$(function () {
  ...
  function darkMode() {
    ...
    document.querySelector(
      ".dark-mode"
    ).innerHTML = `<span class="material-icons">light_mode</span>`;
  ...
  function lightMode() {
    ...
    document.querySelector(
      ".dark-mode"
    ).innerHTML = `<span class="material-icons">dark_mode</span>`;
  ...
  $("#grid-id").click(function () {
    $(this).addClass("bold-text");
    $("#grid").slideDown(500);
    $(this).siblings().removeClass("bold-text");
    $("#grid").siblings().hide();
  });
  $("#slider-id").click(function () {
    $(this).addClass("bold-text");
    $("#slider").slideDown(500);
    $(this).siblings().removeClass("bold-text");
    $("#slider").siblings().hide();
  });
  ...
  $("#responsive-modal-id").click(function () {
    $(this).addClass("bold-text");
    $("#modal").slideDown(500);
    $(this).siblings().removeClass("bold-text");
    $("#modal").siblings().hide();
  });
  $("#responsive-grid-id").click(function () {
    $(this).addClass("bold-text");
    $("#grid").slideDown(500);
    $(this).siblings().removeClass("bold-text");
    $("#grid").siblings().hide();
  });
  $("#responsive-slider-id").click(function () {
    $(this).addClass("bold-text");
    $("#slider").slideDown(500);
    $(this).siblings().removeClass("bold-text");
    $("#slider").siblings().hide();
